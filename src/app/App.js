...
import CorteNuevo                 from './components/CorteNuevo';
import Index                      from './components/Index';
import ListaAbordaje              from './components/ListaAbordaje';
import ListaNegra                 from './components/ListaNegra';
import ReasignacionesPendientes   from './components/ReasignacionesPendientes';
...
import NavBarReservaciones        from './components/NavBar/NavBarReservacion';
import NavBarCancelacion          from './components/NavBar/NavBarCancelacion';
...
import SolicitudDescuentos        from './components/SolicitudDescuentos';
    ...
    return (
     // <Router>
      <React.Fragment>
        ...
        {/*Navegacion de SuperUsuario **ADMIN** */} 
        ...
        <Route path="/CorteNuevo/:id_Usuario?"                 component={NavBar}/>
        <Route path="/CorteNuevo/:id_Usuario?"                 component={CorteNuevo}/>
        ...
        <Route path="/ReasignacionesPendientes/:id_Usuario?"   component={NavBar}/>
        <Route path="/ReasignacionesPendientes/:id_Usuario?"   component={ReasignacionesPendientes}/>
        ...
        <Route path="/ViajeRedondo/:id_Usuario?"               component={NavBar}/>
        <Route path="/ViajeRedondo/:id_Usuario?"               component={ViajeRedondo}/>
        ...
        <Route path="/Ventas_ViajeRedondo/:id_Usuario?"      component={NavBarVentas}/>
        <Route path="/Ventas_ViajeRedondo/:id_Usuario?"      component={ViajeRedondo}/>
        {/*Navegacion de Agente de ventas con Reservacion */}
        <Route path="/Reservaciones_Corte/:id_Usuario?"             component={NavBarReservaciones}/>
        <Route path="/Reservaciones_Corte/:id_Usuario?"             component={Corte}/>
        <Route path="/Reservaciones_Clientes/:id_Usuario?"          component={NavBarReservaciones}/>
        <Route path="/Reservaciones_Clientes/:id_Usuario?"          component={Clientes}/>
        <Route path="/Reservaciones_Index/:id_Usuario?"             component={NavBarReservaciones}/>
        <Route path="/Reservaciones_Index/:id_Usuario?"             component={Index}/>
        <Route path="/Reservaciones_Publicidad/:id_Usuario?"        component={NavBarReservaciones}/>
        <Route path="/Reservaciones_Publicidad/:id_Usuario?"        component={Publicidad}/>
        <Route path="/Reservaciones_Viajes/:id_Usuario?"            component={NavBarReservaciones}/>
        <Route path="/Reservaciones_Viajes/:id_Usuario?"            component={Viajes}/>
        <Route path="/Reservaciones_VentasConcluidas/:id_Usuario?"  component={NavBarReservaciones}/>
        <Route path="/Reservaciones_VentasConcluidas/:id_Usuario?"  component={VentasConcluidas}/>
        <Route path="/Reservaciones_VentasCanceladas/:id_Usuario?"  component={NavBarReservaciones}/>
        <Route path="/Reservaciones_VentasCanceladas/:id_Usuario?"  component={VentasCanceladas}/>
        <Route path="/Reservaciones_NuevaReservacion/:id_Usuario?"  component={NavBarReservaciones}/>
        <Route path="/Reservaciones_NuevaReservacion/:id_Usuario?"  component={NuevaReservacion}/>
        <Route path="/Reservaciones_ReservacionesCanceladas/:id_Usuario?"    component={NavBarReservaciones}/>
        <Route path="/Reservaciones_ReservacionesCanceladas/:id_Usuario?"    component={ReservacionesCanceladas}/>
        <Route path="/Reservaciones_ReservacionesConcluidas/:id_Usuario?"    component={NavBarReservaciones}/>
        <Route path="/Reservaciones_ReservacionesConcluidas/:id_Usuario?"    component={ReservacionesConcluidas}/>
        <Route path="/Reservaciones_ViajeRedondo/:id_Usuario?"               component={NavBarReservaciones}/>
        <Route path="/Reservaciones_ViajeRedondo/:id_Usuario?"               component={ViajeRedondo}/>
        {/*Navegacion de Agente de ventas con Reservacion */}
        ...
        <Route path="/Viajes_ModificarVenta/:id_Usuario?"             component={NavBarViajes}/>
        <Route path="/Viajes_ModificarVenta/:id_Usuario?"             component={ModificarVenta}/>
        ...
        <Route path="/Viajes_Descuentos/:id_Usuario?"                 component={NavBarViajes}/>
        <Route path="/Viajes_Descuentos/:id_Usuario?"                 component={Descuentos}/>
        <Route path="/Viajes_NuevaReservacion/:id_Usuario?"           component={NavBarViajes}/>
        <Route path="/Viajes_NuevaReservacion/:id_Usuario?"           component={NuevaReservacion}/>
        <Route path="/Viajes_ModificarReservacion/:id_Usuario?"       component={NavBarViajes}/>
        <Route path="/Viajes_ModificarReservacion/:id_Usuario?"       component={ModificarReservacion}/>
        <Route path="/Viajes_ReservacionesCanceladas/:id_Usuario?"    component={NavBarViajes}/>
        <Route path="/Viajes_ReservacionesCanceladas/:id_Usuario?"    component={ReservacionesCanceladas}/>
        <Route path="/Viajes_ReservacionesConcluidas/:id_Usuario?"    component={NavBarViajes}/>
        <Route path="/Viajes_ReservacionesConcluidas/:id_Usuario?"    component={ReservacionesConcluidas}/>
        <Route path="/Viajes_ConfigurarPrecios/:id_Usuario?"          component={NavBarViajes}/>
        <Route path="/Viajes_ConfigurarPrecios/:id_Usuario?"          component={ConfigurarPrecios}/>
        <Route path="/Viajes_Rutas/:id_Usuario?"                      component={NavBarViajes}/>
        <Route path="/Viajes_Rutas/:id_Usuario?"                      component={Rutas}/>
        <Route path="/Viajes_ListaAbordaje/:id_Usuario?"              component={NavBarViajes}/>
        <Route path="/Viajes_ListaAbordaje/:id_Usuario?"              component={ListaAbordaje}/>
        <Route path="/Viajes_ListaNegra/:id_Usuario?"                 component={NavBarViajes}/>
        <Route path="/Viajes_ListaNegra/:id_Usuario?"                 component={ListaNegra}/>
        {/*Navegacion Matriz */}
        ...
        <Route path="/Matriz_ListaNegra/:id_Usuario?"                 component={NavBarMatriz}/>
        <Route path="/Matriz_ListaNegra/:id_Usuario?"                 component={ListaNegra}/>
        ...
        <Route path="/Matriz_ModificarReservacion/:id_Usuario?"       component={NavBarMatriz}/>
        <Route path="/Matriz_ModificarReservacion/:id_Usuario?"       component={ModificarReservacion}/>
        ...
        <Route path="/Matriz_ViajeRedondo/:id_Usuario?"               component={NavBarMatriz}/>
        <Route path="/Matriz_ViajeRedondo/:id_Usuario?"               component={ViajeRedondo}/>
        <Route path="/Matriz_Rutas/:id_Usuario?"                      component={NavBarMatriz}/>
        <Route path="/Matriz_Rutas/:id_Usuario?"                      component={Rutas}/>
        <Route path="/Matriz_ConfigurarViajes/:id_Usuario?"           component={NavBarMatriz}/>
        <Route path="/Matriz_ConfigurarViajes/:id_Usuario?"           component={ConfigurarViajes}/>
        {/*Navegacion Cancelacion */}
        <Route path="/Cancelacion_Index/:id_Usuario?"                      component={NavBarCancelacion}/>
        <Route path="/Cancelacion_Index/:id_Usuario?"                      component={Index}/>
        <Route path="/Cancelacion_ReservacionesCanceladas/:id_Usuario?"    component={NavBarCancelacion}/>
        <Route path="/Cancelacion_ReservacionesCanceladas/:id_Usuario?"    component={ReservacionesCanceladas}/>
        <Route path="/Cancelacion_ModificarReservacion/:id_Usuario?"       component={NavBarCancelacion}/>
        <Route path="/Cancelacion_ModificarReservacion/:id_Usuario?"       component={ModificarReservacion}/>
        <Route path="/Cancelacion_ModificarVenta/:id_Usuario?"             component={NavBarCancelacion}/>
        <Route path="/Cancelacion_ModificarVenta/:id_Usuario?"             component={ModificarVenta}/>
        <Route path="/Cancelacion_VentasCanceladas/:id_Usuario?"           component={NavBarCancelacion}/>
        <Route path="/Cancelacion_VentasCanceladas/:id_Usuario?"           component={VentasCanceladas}/>
        <Route path="/Cancelacion_SolicitudDescuentos/:id_Usuario?"        component={NavBarCancelacion}/>
        <Route path="/Cancelacion_SolicitudDescuentos/:id_Usuario?"        component={SolicitudDescuentos}/>
      </React.Fragment>  
    )
  }
}
