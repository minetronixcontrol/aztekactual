                            ...
                            <div key={'client'+i}>
                                <Row>
                                    <div class="form-check">
                                        <input type="hidden" id={`hiddenSeat${i}`} value={i}></input>
...
export default class papeleraDeReciclaje extends React.Component {
    ...
    finishButtonClick() {
        if((generalData.vendedor.seguridad == 'Ventas') && (generalData.cobro.anticipo < (parseFloat(generalData.cobro.total)/2))){
            ...
            let pagado = 'true';
            if(generalData.cobro.anticipo < parseFloat(generalData.cobro.total) ){
                pagado = 'false';
            }
            fetch(`/api/Usuarios/${generalData.vendedor.id_Usuario}/actualizaYobtenFolioReservacion`, {
                method: 'PUT',
                body: JSON.stringify({pasajeros, razones, descuentos, generalData, pagado}),
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
                }
                ...
                for (let i = 0; i < data.rJson.length; i++) {
                    datos = {
                        ...
                        'cobro': {
                            ...
                            'anticipo': generalData.cobro.anticipo
                        },
                        'configuracion': {
