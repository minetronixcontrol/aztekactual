...
class NavBarMain extends React.Component {
  ...
  constructor(props) {
    ...
    this.redireccionarIrSolicitudDescuentos = this.redireccionarIrSolicitudDescuentos.bind(this);
    this.fetchUser = this.fetchUser.bind(this);
    
    this.state = {isOpen: false, IrNuevaVenta:false, IrLogin:false, IrModificarVenta:false, IrVentasConcluidas:false, IrVentasCanceladas:false, IrNuevaReservacion:false, IrModificarReservacion:false, IrReservacionesConcluidas:false, IrReservacionesCanceladas:false, IrClientes:false, IrOrigenesyDestinos:false, IrCamiones:false, IrTripulantes:false, IrViajes:false, IrListaAbordaje:false, IrListaNegra:false, IrCorte:false,IrConfigurarViajes:false,IrUsuarios:false,IrConfiguracionBoletos:false,IrConfiguracionDePublicidad:false, IrPublicidad:false,IrPapeleraDeReciclaje:false,IrSucursales:false, IrConfigurarSucursales:false,IrSolicitudDescuentos:false, IrPrecios:false, IrConfigurarPrecios:false,IrDescuentos:false, nombre: '', apellidoPaterno: '', apellidoMaterno: '', urlActual: urlActual[1]}
    ...
    redireccionarIrSolicitudDescuentos(e){ e.preventDefault(); this.setState({IrSolicitudDescuentos:true})};      
    toggle() {this.setState({isOpen: !this.state.isOpen})};

  render() {
    //Tenemos que reemplazar :id_Usuario por la variable username
    if(this.state.IrCorte){return <Redirect to= {"/Cancelacion_Corte/"+username}/>};
    if(this.state.IrConfigurarViajes){return <Redirect to= {"/Cancelacion_ConfigurarViajes/"+username}/>};
    if(this.state.IrConfiguracionBoletos){return <Redirect to= {"/Cancelacion_ConfiguracionBoletos/"+username}/>};
    if(this.state.IrConfiguracionDePublicidad){return <Redirect to= {"/Cancelacion_ConfiguracionDePublicidad/"+username}/>};
    if(this.state.IrCamiones){return <Redirect to= {"/Cancelacion_Camiones/"+username}/>};//
    if(this.state.IrClientes){return <Redirect to= {"/Cancelacion_Clientes/"+username}/>};//
    if(this.state.IrNuevaVenta){return <Redirect to= {"/Cancelacion_Index/"+username}/>};//
    if(this.state.IrLogin){return <Redirect to= {"/"+username}/>};
    if(this.state.IrListaAbordaje){return <Redirect to= {"/Cancelacion_ListaAbordaje/"+username}/>};
    if(this.state.IrListaNegra){return <Redirect to= {"/Cancelacion_ListaNegra/"+username}/>};
    if(this.state.IrNuevaReservacion){return <Redirect to= {"/Cancelacion_NuevaReservacion/"+username}/>};//
    if(this.state.IrModificarVenta){return <Redirect to= {"/Cancelacion_ModificarVenta/"+username}/>};
    if(this.state.IrModificarReservacion){return <Redirect to= {"/Cancelacion_ModificarReservacion/"+username}/>};
    if(this.state.IrOrigenesyDestinos){return <Redirect to= {"/Cancelacion_OrigenesyDestinos/"+username}/>};//
    if(this.state.IrPublicidad){return <Redirect to= {"/Cancelacion_Publicidad/"+username}/>};
    if(this.state.IrPapeleraDeReciclaje){return <Redirect to= {"/Cancelacion_PapeleraDeReciclaje/"+username}/>};
    if(this.state.IrReservacionesConcluidas){return <Redirect to= {"/Cancelacion_ReservacionesConcluidas/"+username}/>};
    if(this.state.IrReservacionesCanceladas){return <Redirect to= {"/Cancelacion_ReservacionesCanceladas/"+username}/>};
    if(this.state.IrTripulantes){return <Redirect to= {"/Cancelacion_Tripulantes/"+username}/>};
    if(this.state.IrUsuarios){return <Redirect to= {"/Cancelacion_Usuarios/"+username}/>};
    if(this.state.IrViajes){return <Redirect to= {"/Cancelacion_Viajes/"+username}/>};
    if(this.state.IrVentasConcluidas){return <Redirect to= {"/Cancelacion_VentasConcluidas/"+username}/>};
    if(this.state.IrVentasCanceladas){return <Redirect to= {"/Cancelacion_VentasCanceladas/"+username}/>};
    if(this.state.IrSucursales){return <Redirect to= {"/Cancelacion_Sucursales/"+username}/>};
    if(this.state.IrConfigurarSucursales){return <Redirect to= {"/Cancelacion_ConfigurarSucursales/"+username}/>};
    if(this.state.IrDescuentos){return <Redirect to= {"/Cancelacion_Descuentos/"+username}/>};
    if(this.state.IrConfigurarPrecios){return <Redirect to= {"/Cancelacion_ConfigurarPrecios/"+username}/>};
    if(this.state.IrPrecios){return <Redirect to= {"/Cancelacion_Precios/"+username}/>};
    if(this.state.IrSolicitudDescuentos){return <Redirect to= {"/Cancelacion_SolicitudDescuentos/"+username}/>};
          ...
          <Collapse isOpen={this.state.isOpen} navbar>
            <Nav className="ml-auto" navbar>
              <UncontrolledDropdown nav inNavbar>
                ...
                <DropdownMenu left>
                  {(this.state.urlActual == 'Cancelacion_ModificarVenta')? 
                    ''
                    :
                    (
                      <DropdownItem>
              ...
              <UncontrolledDropdown nav inNavbar>
                ...
                (
                  <DropdownItem>
                    <NavItem onClick={this.redireccionarIrSolicitudDescuentos}>
