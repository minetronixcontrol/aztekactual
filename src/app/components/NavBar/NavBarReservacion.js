...
class NavBarMainReservacion extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {isOpen: false, IrNuevaVenta:false,IrLogin:false, IrVentasConcluidas:false, IrVentasCanceladas:false, IrNuevaReservacion:false, IrReservacionesConcluidas:false, IrReservacionesCanceladas:false, IrClientes:false, IrViajes:false, IrCorte:false,IrPublicidad:false,  IrViajeRedondo:false, nombre: '', apellidoPaterno: '', apellidoMaterno: '', urlActual: urlActual[1]}};
  ...
  render() {
    if(this.state.IrCorte){return <Redirect to= {"/Reservaciones_Corte/"+username}/>};
    if(this.state.IrClientes){return <Redirect to= {"/Reservaciones_Clientes/"+username}/>};//
    if(this.state.IrNuevaVenta){return <Redirect to= {"/Reservaciones_Index/"+username}/>};//
    if(this.state.IrNuevaReservacion){return <Redirect to={"/Reservaciones_NuevaReservacion/"+username}/>};//
    if(this.state.IrReservacionesConcluidas){return <Redirect to={"/Reservaciones_ReservacionesConcluidas/"+username}/>};
    if(this.state.IrReservacionesCanceladas){return <Redirect to={"/Reservaciones_ReservacionesCanceladas/"+username}/>};
    if(this.state.IrLogin){return <Redirect to= {"/"+username}/>};
    if(this.state.IrPublicidad){return <Redirect to= {"/Reservaciones_Publicidad/"+username}/>};
    if(this.state.IrViajes){return <Redirect to= {"/Reservaciones_Viajes/"+username}/>};
    if(this.state.IrVentasConcluidas){return <Redirect to= {"/Reservaciones_VentasConcluidas/"+username}/>};
    if(this.state.IrVentasCanceladas){return <Redirect to= {"/Reservaciones_VentasCanceladas/"+username}/>};
    if(this.state.IrViajeRedondo){return <Redirect to= {"/Reservaciones_ViajeRedondo/"+username}/>};
          ...
          <Collapse isOpen={this.state.isOpen} navbar>
            <Nav className="ml-auto" navbar>
              <UncontrolledDropdown nav inNavbar>
                ...
                <DropdownMenu left>
                {(this.state.urlActual == 'Reservaciones_Index')? 
                ''
                :
                (
                  <DropdownItem>
                ...
                }
                {
                  (this.state.viajeRedondo)? 
                    ((this.state.urlActual == 'Reservaciones_ViajeRedondo')? 
                    ''
                    : 
                    (
                      <DropdownItem>
                ...
                {(this.state.urlActual == 'Reservaciones_VentasConcluidas')? 
                ''
                :
                (
                  <DropdownItem>
                ...
                {(this.state.urlActual == 'Reservaciones_VentasCanceladas')? 
                ''
                :
                (
                  <DropdownItem>
              ...
              <UncontrolledDropdown nav inNavbar>
                ...
                <DropdownMenu left>
                  <DropdownItem>
                    {(this.state.urlActual == 'Reservaciones_NuevaReservacion')?
                    ''
                    :
                    (
                  ...
                  <DropdownItem>
                    {(this.state.urlActual == 'Reservaciones_ReservacionesConcluidas')?
                    ''
                    :
                    (
                  ...
                  <DropdownItem>
                    {(this.state.urlActual == 'Reservaciones_ReservacionesCanceladas')?
                    ''
                    :
                    (
              ...
              <UncontrolledDropdown nav inNavbar>
                ...
                {(this.state.urlActual == 'Reservaciones_Clientes')? 
                ''
                :
                (
                  <DropdownItem>
                ...
                {(this.state.urlActual == 'Reservaciones_Viajes')? 
                ''
                :
                (
                  <DropdownItem>
              ...
              <UncontrolledDropdown nav inNavbar>
                ...
                {(this.state.urlActual == 'Reservaciones_Corte')? 
                ''
                :
                (
                  <DropdownItem>
              ...
              <UncontrolledDropdown nav inNavbar>
                ...
                {(this.state.urlActual == 'Reservaciones_Publicidad')? 
                ''
                :
                (
                  <DropdownItem>
...
export default NavBarMainReservacion