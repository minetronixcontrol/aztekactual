...
class NavBarMain extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {viajeRedondo: false, isOpen: false, IrNuevaVenta:false, IrLogin:false, IrVentasConcluidas:false, IrVentasCanceladas:false, IrNuevaReservacion:false, IrModificarReservacion:false, IrReservacionesConcluidas:false, IrReservacionesCanceladas:false, IrConfigurarViajes: false, IrRutas:false, IrClientes:false, IrOrigenesyDestinos:false, IrViajes:false, IrListaAbordaje:false, IrCorte:false, IrUsuarios:false, IrPublicidad:false, IrListaNegra: false, IrViajeRedondo:false, nombre: '', apellidoPaterno: '', apellidoMaterno: '', urlActual: urlActual[1]}};
  ...
  render() {
    if(this.state.IrCorte){return <Redirect to={"/Matriz_Corte/"+username}/>};
    if(this.state.IrCamiones){return <Redirect to={"/Matriz_Camiones/"+username}/>};//
    if(this.state.IrClientes){return <Redirect to={"/Matriz_Clientes/"+username}/>};//
    if(this.state.IrNuevaVenta){return <Redirect to={"/Matriz_Index/"+username}/>};//
    if(this.state.IrLogin){return <Redirect to= "/"/>};
    if(this.state.IrListaAbordaje){return <Redirect to={"/Matriz_ListaAbordaje/"+username}/>};
    if(this.state.IrListaNegra){return <Redirect to={"/Matriz_ListaNegra/"+username}/>};
    if(this.state.IrNuevaReservacion){return <Redirect to={"/Matriz_NuevaReservacion/"+username}/>};//
    if(this.state.IrModificarReservacion){return <Redirect to= {"/Matriz_ModificarReservacion/"+username}/>};
    if(this.state.IrOrigenesyDestinos){return <Redirect to={"/Matriz_OrigenesyDestinos/"+username}/>};//
    if(this.state.IrPublicidad){return <Redirect to={"/Matriz_Publicidad/"+username}/>};
    if(this.state.IrReservacionesConcluidas){return <Redirect to={"/Matriz_ReservacionesConcluidas/"+username}/>};
    if(this.state.IrReservacionesCanceladas){return <Redirect to={"/Matriz_ReservacionesCanceladas/"+username}/>};
    if(this.state.IrConfigurarViajes){return <Redirect to= {"/Matriz_ConfigurarViajes/"+username}/>};
    if(this.state.IrRutas){return <Redirect to= {"/Matriz_Rutas/"+username}/>};
    if(this.state.IrViajes){return <Redirect to={"/Matriz_Viajes/"+username}/>};
    if(this.state.IrVentasConcluidas){return <Redirect to={"/Matriz_VentasConcluidas/"+username}/>};
    if(this.state.IrVentasCanceladas){return <Redirect to={"/Matriz_VentasCanceladas/"+username}/>};
    if(this.state.IrViajeRedondo){return <Redirect to= {"/Matriz_ViajeRedondo/"+username}/>};
          ...
          <Collapse isOpen={this.state.isOpen} navbar>
            <Nav className="ml-auto" navbar>
              <UncontrolledDropdown nav inNavbar>
                ...
                <DropdownMenu left>
                  <DropdownItem>
                    {(this.state.urlActual == 'Matriz_Index')?
                      ''
                    :
                      (
                  ...
                  </DropdownItem>
                  {
                    ...
                    (this.state.viajeRedondo)? 
                      ((this.state.urlActual == 'Matriz_ViajeRedondo')? 
                      ''
                      : 
                      (
                        <DropdownItem>
                  ...
                  <DropdownItem>
                    {(this.state.urlActual== 'Matriz_VentasConcluidas')?
                        ''
                      :
                      (
                  ...
                  <DropdownItem>
                    {(this.state.urlActual == 'Matriz_VentasCanceladas')?
                      ''
                      :
                      (
              ...
              <UncontrolledDropdown nav inNavbar>
                ...
                <DropdownMenu left>
                  <DropdownItem>
                    {(this.state.urlActual == 'Matriz_NuevaReservacion')?
                    ''
                    :
                    (
                  ...
                  {(this.state.urlActual == 'Matriz_ModificarReservacion')? 
                    ''
                    :
                    (
                      <DropdownItem>
                  ...
                  <DropdownItem>
                    {(this.state.urlActual == 'Matriz_ReservacionesConcluidas')?
                    ''
                    :
                    (
                  ...
                  <DropdownItem>
                    {(this.state.urlActual == 'Matriz_ReservacionesCanceladas')?
                    ''
                    :
                    (
              ...
              <UncontrolledDropdown nav inNavbar>
                ...
                <DropdownMenu left>
                  <DropdownItem>
                    {(this.state.urlActual == 'Matriz_Clientes')?
                    ''
                    :
                    (
                  ...
                  <DropdownItem>
                    {(this.state.urlActual == 'Matriz_OrigenesyDestinos')?
                    ''
                    :
                    (
                  ...
                  <DropdownItem>
                    {(this.state.urlActual == 'Matriz_Viajes')?
                    ''
                    :
                    (
              ...
              <UncontrolledDropdown nav inNavbar>
                ...
                <DropdownMenu right>
                  <DropdownItem>
                    {(this.state.urlActual == 'Matriz_ListaAbordaje')?
                    ''
                    :
                    (
                  ...
                  <DropdownItem>
                    {(this.state.urlActual == 'Matriz_ListaNegra')?
                    ''
                    :
                    (
              ...
              <UncontrolledDropdown nav inNavbar>
                ...
                <DropdownMenu>
                  <DropdownItem>
                    {(this.state.urlActual == 'Matriz_Corte')?
                    ''
                    :
                    (
              ...
              <UncontrolledDropdown nav inNavbar>
                ...
                <DropdownMenu left>
                {(this.state.urlActual == 'Matriz_ConfigurarViajes')? 
                ''
                :
                (
                  <DropdownItem>
                ...
                {(this.state.urlActual == 'Matriz_Rutas')? 
                ''
                :
                (
                  <DropdownItem>
              ...
              <UncontrolledDropdown nav inNavbar>
                ...
                <DropdownMenu right>
                  <DropdownItem>
                    {(this.state.urlActual == 'Matriz_Publicidad')?
                    ''
                    :
                    (
